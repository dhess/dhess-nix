...
, exceptions, fetchgit, filepath, free, generic-random
, ghc-datasize, Glob, hashable, hashing, haskeline, hedgehog
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    filepath free ghc-datasize hashable hashing haskeline http-client
